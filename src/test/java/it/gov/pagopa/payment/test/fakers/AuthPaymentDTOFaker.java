...
public class AuthPaymentDTOFaker {
  ...
  public static AuthPaymentDTO mockInstance(Integer bias, Transaction transaction){
    return mockInstanceBuilder(bias,transaction).build();
  }

  public static AuthPaymentDTO.AuthPaymentDTOBuilder<?,?> mockInstanceBuilder(Integer bias, Transaction transaction) {
