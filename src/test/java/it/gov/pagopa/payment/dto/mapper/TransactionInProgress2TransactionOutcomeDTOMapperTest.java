...
class TransactionInProgress2TransactionOutcomeDTOMapperTest {
    ...
    void testNoRejections(){
        ...
        trx.setReward(100L);
        trx.setRewards(Map.of(trx.getInitiativeId(), new Reward(trx.getInitiativeId(), "ORGANIZATIONID", Utils.centsToEuro(trx.getReward()))));
    ...
    void testOnlyInitiativeRejections(){
        ...
        Assertions.assertEquals(Map.of(trx.getInitiativeId(), trx.getRejectionReasons()), result.getInitiativeRejectionReasons());
    }
    ...
    void testNoBudget(){
        ...
        trx.setReward(0L);
        trx.setRewards(Collections.emptyMap());
        trx.setRejectionReasons(List.of(RewardConstants.TRX_REJECTION_REASON_NO_INITIATIVE, "NO_BUDGET"));
        ...
        Assertions.assertNotNull(result);
        commonAssertions(trx, result);
        Assertions.assertEquals(List.of(RewardConstants.TRX_REJECTION_REASON_NO_INITIATIVE), result.getRejectionReasons());
        Assertions.assertEquals(Map.of(trx.getInitiativeId(), trx.getRejectionReasons()), result.getInitiativeRejectionReasons());
    }
