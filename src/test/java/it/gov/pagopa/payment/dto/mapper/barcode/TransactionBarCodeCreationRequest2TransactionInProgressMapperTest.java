...
class TransactionBarCodeCreationRequest2TransactionInProgressMapperTest {
    ...
    void applyTest() {
        ...
        TestUtils.checkNotNullFields(result, "trxCode", "idTrxAcquirer", "trxChargeDate", "invoiceData",
                ...
                "rewardCents", "rejectionReasons", "rewards", "initiativeRejectionReasons", "initiativeEndDate", "voucherAmountCents", "franchiseName", "pointOfSaleType" );
