...
@WebMvcTest(BRCodePaymentControllerImpl.class)
...
public class BarCodePaymentControllerTest {
    ...
    void createTransaction_testMandatoryFields() throws Exception {
        ...
        MvcResult result = mockMvc.perform(
                        post("/idpay/payment/br-code/citizen")
    ...
    void createTransaction_testMandatoryHeaders() throws Exception {
        TransactionBRCodeResponse body = TransactionBRCodeResponse.builder().initiativeId("INITIATIVE_ID").build();
