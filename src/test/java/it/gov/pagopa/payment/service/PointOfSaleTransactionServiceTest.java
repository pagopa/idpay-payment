...
class PointOfSaleTransactionServiceTest {
    ...
    void getPointOfSaleTransactionList() {
        ...
        TransactionInProgress transaction2 = TransactionInProgressFaker.mockInstance(1, SyncTrxStatus.AUTHORIZED);
        ...
        when(repositoryMock.findPageByFilter(
                anyString(), anyString(), anyString(), any(), any(), any(), any(), any(Pageable.class)
        )).thenReturn(expectedPage);

        Page<TransactionInProgress> resultPage = pointOfSaleTransactionService.getPointOfSaleTransactions("MERCHANTID1", "INITIATIVEID1", "POINTOFSALEID1", "USERFISCALCODE1", null, null, null, Pageable.unpaged());
        ...
        verify(repositoryMock).findPageByFilter("MERCHANTID1", "POINTOFSALEID1", "INITIATIVEID1", "USERID1", null, null, null, Pageable.unpaged());
    }
    ...
    void getPointOfSaleTransactionList_noFiscalCodeFilter() {
        ...
        when(repositoryMock.findPageByFilter(
                anyString(), anyString(), anyString(), isNull(), any(), any(), any(), any(Pageable.class)
        )).thenReturn(expectedPage);

        Page<TransactionInProgress> resultPage = pointOfSaleTransactionService.getPointOfSaleTransactions(
                "MERCHANTID1", "INITIATIVEID1", "POINTOFSALEID1", null, null, null, null, Pageable.unpaged());
        ...
        verify(repositoryMock).findPageByFilter("MERCHANTID1", "POINTOFSALEID1", "INITIATIVEID1", null, null, null, null, Pageable.unpaged());
    }
    ...
    void getPointOfSaleTransactionList_EmptyTransactionInProgressList() {
        ...
        Page<TransactionInProgress> resultPage = pointOfSaleTransactionService.getPointOfSaleTransactions(
                "MERCHANTID1", "INITIATIVEID1", "POINTOFSALEID1", "USERFISCALCODE1", null, null, null, Pageable.unpaged());
