...
class CommonPreAuthServiceTest {
  ...
  void relateUser() {
    ...
    TestUtils.checkNotNullFields(result, "elaborationDateTime", "rewardCents", "trxChargeDate", "initiativeRejectionReasons", "initiativeEndDate", "voucherAmountCents", "invoiceFile");
  ...
  void relateUserIdentified() {
    ...
    Assertions.assertNotNull(result);
    TestUtils.checkNotNullFields(result, "elaborationDateTime", "reward", "trxChargeDate", "initiativeRejectionReasons", "initiativeEndDate", "voucherAmountCents", "invoiceFile");
