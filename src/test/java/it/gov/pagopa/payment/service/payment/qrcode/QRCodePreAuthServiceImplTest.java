...
class QRCodePreAuthServiceImplTest {
  ...
  void relateUser() {
    ...
    verify(transactionInProgressRepositoryMock, times(1)).updateTrxWithStatus(anyString(), anyString(), any(), any(), any(), any(), anyString(),any(), anyLong());
  ...
  void relateUserIdentifiedRejected() {
    ...
    verify(transactionInProgressRepositoryMock, times(0)).updateTrxWithStatus(anyString(), anyString(), any(), any(), any(), any(), anyString(),any(), anyLong());
