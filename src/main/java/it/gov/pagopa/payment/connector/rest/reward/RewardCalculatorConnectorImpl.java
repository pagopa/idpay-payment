            ...
            switch (e.status()) {
                case 403, 409 -> {
                    try {
                        ...
                        throw new InternalServerErrorException("INTERNAL SERVER ERROR", "Something went wrong", false, ex);
                    }
                }
                ...
                case 404 -> throw new NotFoundException("NOT FOUND", "Resource not found on reward-calculator", false, e);
                default -> throw new InternalServerErrorException("INTERNAL SERVER ERROR",
