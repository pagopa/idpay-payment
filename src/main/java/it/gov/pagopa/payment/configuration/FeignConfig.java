...
import it.gov.pagopa.payment.connector.rest.paymentInstrument.PaymentInstrumentRest;
...
@Configuration
@EnableFeignClients(clients = {RewardCalculatorRestClient.class, MerchantRestClient.class, EncryptRest.class, DecryptRest.class, WalletRestClient.class, PaymentInstrumentRest.class})
