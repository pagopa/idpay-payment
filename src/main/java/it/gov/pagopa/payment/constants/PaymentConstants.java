...
public class PaymentConstants {
  ...
  public static final class ExceptionCode {
    ...
    public static final String PAYMENT_MERCHANT_NOT_ALLOWED = "PAYMENT_MERCHANT_NOT_ALLOWED";
    public static final String PAYMENT_MERCHANT_OR_ACQUIRER_NOT_ALLOWED = "PAYMENT_MERCHANT_OR_ACQUIRER_NOT_ALLOWED";

    public static final String PAYMENT_USER_NOT_VALID = "PAYMENT_USER_NOT_VALID";
